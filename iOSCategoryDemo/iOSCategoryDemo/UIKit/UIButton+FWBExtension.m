...
-(void)setCornerStyle:(UICornerStyle)cornerStyle{
    objc_setAssociatedObject(self, @selector(cornerStyle), @(cornerStyle), OBJC_ASSOCIATION_ASSIGN);
}
